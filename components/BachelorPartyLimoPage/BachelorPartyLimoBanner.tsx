    ...
    return (
        <section className="bg-black py-16 font-poppins text-center text-pure-white px-4 border-t border-b border-navy-primary/20">
            <h2 className="text-2xl md:text-3xl font-taviraj font-bold mb-4 max-w-4xl mx-auto leading-tight uppercase">
                Book Your Anniversary Limo Today!
            </h2>
            <p className="text-luxury-text-muted text-[13px] md:text-sm max-w-3xl mx-auto mb-8">
                Make your anniversary extraordinary with our luxury limo service. Whether you're planning a romantic dinner, a surprise getaway, or a night on the town, we ensure an elegant, stress-free, and unforgettable experience.
            </p>
...
export default BachelorPartyLimoBanner;
