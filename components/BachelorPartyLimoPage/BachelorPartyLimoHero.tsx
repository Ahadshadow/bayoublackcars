    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center font-poppins">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/Bachelor Party hero.png')" }} // Party/Nightlife image
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-taviraj text-gold font-bold leading-tight uppercase">
                    Luxury Bachelor Party Limo Service
                </h1>

                <p className="text-sm md:text-base lg:text-lg text-pure-white max-w-4xl leading-relaxed">
                    Make your bachelor party unforgettable with our luxury limo service featuring stretch limos, party buses, and SUV limos equipped with premium sound systems, LED lighting, and fully stocked bars. Leave the logistics to us and enjoy club-hopping, upscale dinners, or weekend getaways in ultimate style, comfort, and safety—turning your ride into a party on wheels.
                </p>
...
export default BachelorPartyLimoHero;
