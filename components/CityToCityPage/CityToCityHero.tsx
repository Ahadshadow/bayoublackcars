    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/City to City Rides.webp')" }} // Using a generic city/driving image
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-taviraj text-pure-white font-bold leading-tight">
                    Luxury City-to-City Rides
                </h1>

                <p className="text-sm md:text-base lg:text-lg text-luxury-text-muted max-w-4xl leading-relaxed">
                    Travelling to and from the airport can often feel like a hassle, especially when dealing with traffic, parking, and long lines. That's where Bayou Black Cars's airport transfer services come in.
                    <br /><br />
                    Whether you're looking for a comfortable private car with a chauffeur service to the airport, a stylish limo for a corporate trip, or a reliable airport chauffeur service. Bayou offers everything you need for a smooth and stress-free journey.
                </p>
