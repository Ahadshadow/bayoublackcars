...
const fleetVehicles = [
    {
        ...
        subtitle: "Sophisticated and discrete transport for long-distance business or solo city-to-city travel.",
    ...
    },
    {
        ...
        subtitle: "The standard for group city-to-city transfers and high-profile ensemble movement.",
    ...
    },
    {
        ...
        subtitle: "High-capacity luxury for entire teams or coordinated group city-to-city travel.",
    ...
    },
    {
        ...
        subtitle: "The ultimate choice for grand arrivals and scenic city-to-city journeys.",
...
export default CityToCityFleet;
