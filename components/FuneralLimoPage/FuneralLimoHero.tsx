    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center font-poppins text-center">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/Funeral Limo Transportation hero.webp')" }} // Dignified/Quiet background
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center space-y-6">
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-taviraj text-gold font-bold leading-tight uppercase max-w-5xl">
                    Limo Funeral Car & Mercedes Funeral Limo – Dignified Funeral Limo Service
                </h1>

                <p className="text-sm md:text-base lg:text-lg text-pure-white max-w-4xl leading-relaxed">
                    Our Funeral Limo Service is designed to provide a compassionate, professional, and stress-free experience. Whether you need a limo funeral car, Mercedes funeral limo, Cadillac funeral limo, or group transportation, we offer discreet, comfortable, and reliable options for grieving families and guests. Our luxury black cars, limousines, and executive SUVs ensure every ride is handled with the utmost sensitivity and respect.
                </p>
...
export default FuneralLimoHero;
