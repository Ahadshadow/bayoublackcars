            ...
            <div className="container-custom mx-auto px-4 max-w-4xl">
                ...
                <div className="space-y-4">
                    {faqData.map((faq, index) => (
                        <details
                            key={index}
                            className="group bg-[#c99736] border border-gold/40 rounded-md overflow-hidden [&_summary::-webkit-details-marker]:hidden shadow-md"
                        >
                            <summary className="flex items-center justify-between p-4 cursor-pointer text-pure-white hover:bg-[#b88a32] transition-colors">
                                <h3 className="font-bold pr-8 text-[13px] md:text-[14px] uppercase tracking-wide">
                                    {faq.question}
                                </h3>
                            ...
                            <div className="p-4 pt-1 pb-4 text-pure-white/90 text-[12px] md:text-[13px] leading-relaxed whitespace-pre-line border-t border-white/20 bg-[#b88a32] uppercase">
