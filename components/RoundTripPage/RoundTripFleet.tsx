        ...
        <section className="py-20 bg-pure-white font-poppins">
            <div className="container-custom mx-auto px-4 max-w-7xl text-center">
                <h2 className="text-3xl md:text-4xl font-taviraj text-navy-primary font-bold mb-6">
                    A Fleet Tailored to Your Journey
                </h2>
                <p className="text-luxury-text-muted text-[13px] md:text-sm max-w-5xl mx-auto leading-relaxed mb-12">
                    Whether you're traveling solo, with a partner, or in a group, Bayou offers a fleet designed to meet your comfort, style, and space requirements. Every vehicle is maintained to the highest standards, combining elegance with functionality for an unmatched travel experience.
                </p>
