    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/Corporate Event Transportation hero.jpg')" }} // Using a generic corporate event / conference meeting image
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-taviraj text-pure-white font-bold leading-tight">
                    Corporate Event Transportation - Bayou Black Cars
                </h1>

                <p className="text-sm md:text-base lg:text-lg text-luxury-text-muted max-w-4xl leading-relaxed">
                    Ensure your team and guests travel in style with Bayou Black Cars's corporate event transportation. Our fleet of luxury black cars and professional chauffeurs provide punctual, comfortable, and discreet service for conferences, meetings, galas, and corporate celebrations. From individual executive transfers to large group logistics, we deliver a seamless travel experience that reflects your company's professionalism and prestige.
                </p>
