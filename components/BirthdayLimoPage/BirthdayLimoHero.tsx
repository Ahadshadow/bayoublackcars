    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/Birthday Limo Service hero.webp')" }} // Using a generic birthday party/celebration image
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                ...
                <p className="text-sm md:text-base lg:text-lg text-pure-white max-w-4xl leading-relaxed">
                    At Bayou Black Cars, we turn ordinary birthdays into extraordinary experiences with our top-of-the-line fleet, professional chauffeurs, and premium amenities—sit back, relax, and enjoy the ride while we take care of the details!
                </p>
...
export default BirthdayLimoHero;
