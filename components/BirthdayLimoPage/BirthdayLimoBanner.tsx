    ...
    return (
        <section className="bg-black py-16 font-poppins text-center text-pure-white px-4 border-t border-b border-navy-primary/20">
            <h2 className="text-2xl md:text-3xl font-taviraj font-bold mb-4 max-w-4xl mx-auto leading-tight">
                Ready to Ride in Style? Book Your Birthday Limo Now!
            </h2>
            <p className="text-luxury-text-muted text-[13px] md:text-sm max-w-3xl mx-auto mb-8">
                Make your birthday one to remember with a luxurious limousine ride! Whether you want a VIP experience, a night of fun with friends, or a stylish family celebration, Bayou Black Cars has the perfect limo for you.
            </p>
...
export default BirthdayLimoBanner;
