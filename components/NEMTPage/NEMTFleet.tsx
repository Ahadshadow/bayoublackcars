...
const fleetVehicles = [
    {
        ...
        subtitle: "Sophisticated and discrete transport for medical consultations and routine checkups.",
    ...
    },
    {
        ...
        subtitle: "Perfect for patients requiring more space or traveling with a companion.",
    ...
    },
    {
        ...
        subtitle: "High-capacity transit for group medical appointments or facility transfers.",
    ...
    },
    {
        ...
        subtitle: "The ultimate in patient comfort and privacy for landmark medical journeys.",
            ...
            <div className="container-custom mx-auto px-4 max-w-7xl">
                <div className="mb-12">
                    ...
                    <p className="text-luxury-text-muted text-[11px] md:text-[13px] max-w-6xl mx-auto leading-relaxed">
                        Allow Bayou Black Cars to take you on a luxurious and stylish ride in one of our premium vehicles. There is nothing that brings a better travel experience than having your own reliable service for your business trips as well as family trips. Do not fret if you’re coming to a big meeting, we’ll have sleek sedans ready for you.
                    </p>
                </div>
