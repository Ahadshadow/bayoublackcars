    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/Wedding Transportation hero.webp')" }} // Using a generic wedding / bride & groom image
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-taviraj text-pure-white font-bold leading-tight max-w-5xl">
                    Wedding Limo Service - Let's Make Your Day Unforgettable
                </h1>

                <p className="text-sm md:text-base lg:text-lg text-luxury-text-muted max-w-4xl leading-relaxed">
                    Our wedding day is a once-in-a-lifetime event—make every moment magical with our luxury wedding limo service. At Bayou Black Cars, we specialize in providing luxurious, reliable, and stress-free wedding limo services to ensure that your transportation is as magical as your love story. Whether you're looking for a classic stretch limousine, a sleek black SUV, or a vintage-style car, our fleet is designed to create a memorable entrance and exit for your big day.
                </p>
...
export default WeddingLimoHero;
