    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center font-poppins">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/Concert Limo Services hero.png')" }} // Concert/Music event image
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-taviraj text-gold font-bold leading-tight uppercase">
                    Luxury Concert Limo Service
                </h1>

                <p className="text-sm md:text-base lg:text-lg text-pure-white max-w-4xl leading-relaxed">
                    A night out at a concert isn't just about the music—it's about the entire experience. Imagine stepping out of a sleek, luxury limousine, skipping the parking nightmares, and heading straight to the entrance like a VIP. With Bayou Black Cars, your concert journey begins long before the first song plays.
                </p>
...
export default ConcertLimoHero;
