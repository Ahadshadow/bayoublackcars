    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/city tours hero .png')" }} // Using a generic city architecture image
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                ...
                <p className="text-sm md:text-base lg:text-lg text-luxury-text-muted max-w-4xl leading-relaxed">
                    Experience the ultimate luxury city tour with Bayou Black Cars. Whether you're discovering Chicago's iconic skyline or exploring the rich culture of the city, our private chauffeur-driven city tours provide an exclusive way to see the sights.
                </p>
