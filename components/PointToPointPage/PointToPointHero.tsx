    ...
    return (
        <section className="relative h-[60vh] min-h-[500px] max-h-[700px] w-full bg-slate-black overflow-hidden flex items-center justify-center">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/HERO section/servies/Point to Point Car Service hero.png')" }}
            >
            ...
            <div className="relative z-10 container-custom mx-auto px-4 h-full flex flex-col justify-center items-center text-center space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-taviraj text-pure-white font-bold leading-tight">
                    Luxury Point-to-Point Limo Service
                </h1>

                <p className="text-sm md:text-base lg:text-lg text-luxury-text-muted max-w-4xl leading-relaxed">
                    Travel effortlessly between destinations with Bayou point-to-point Limo service.
                    Our fleet of luxury black cars and limousines, paired with professional chauffeurs,
                    offers direct, private, and comfortable transportation for business meetings, airport transfers,
                    special events, or nights on the town. Enjoy punctual pickups, smooth rides, and the
                    elegance you deserve, every time you travel.
                </p>
...
export default PointToPointHero;
